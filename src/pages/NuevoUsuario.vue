...
export default {
  ...
  methods: {
    registrar() {
      ...
      axios.post(`${env.endpoint}/api_inventarioit/usuarios/registrar_usuario` ,new FormData(form))
        .then(res => {
    ...
    validarExisteRut() {
                ...
                axios.post(`${env.endpoint}/api_inventarioit/usuarios/validarExisteRut`, formData)
                    .then(res => {
                        this.respuesta = res.data.response
